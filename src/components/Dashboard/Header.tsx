...
const Header = () => {
  return (
    <header className="flex items-center justify-between w-full px-4 bg-white border-b h-[100px]">
      <div>
        <svg
          width="174"
          height="36"
      ...
      <div className="flex items-center text-[#213F7D]">
        ...
        <a href="#" className=" ml-5 mr-3 avatar avatar-sm w-[48px] h-[50px]">
          {" "}
          <img
            src={tie}
            alt="Photo of Praveen Juge"
            className="rounded-[100%] w-[48px] h-[50px]"
          />{" "}
        </a>{" "}
        <a>Tunde Philps</a>
      </div>{" "}
